...
Добро пожаловать в **Eventer** — прототип мобильного приложения, специально разработанный для стажеров QA для отработки навыков тестирования. Это приложение для просмотра и создания (смоделированных) мероприятий, и оно намеренно содержит множество ошибок. Сервер: https://r1.mocker.surfstudio.ru/files/QATraineeApp/
